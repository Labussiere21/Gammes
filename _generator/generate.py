...
SCALE_DEFS = [
    ...
    {"id":"penta_maj7",      "label":"Pentatonique majeure 7", "label_en":"Major 7 Pentatonic",     "sub":"5 notes",             "sub_en":"5 notes",             "group":1,"diat":False,"fam":"maj","ls":[0,1,2,4,6],       "iv":[0,2,4,7,11]},
    ...
    {"id":"half_dim",        "label":"Demi-diminuée",          "label_en":"Half Diminished",        "sub":"= Locrien ♮2",           "sub_en":"= Locrian ♮2",           "group":1,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6],   "iv":[0,2,3,5,6,8,10]},
    ...
    {"id":"aug_hex",         "label":"Hexatonique augmentée",  "label_en":"Augmented Hexatonic",    "sub":"6 notes, symétrique", "sub_en":"6 notes, symmetric",  "group":1,"diat":False,"fam":"maj","ls":[0,2,2,4,5,6],     "iv":[0,3,4,7,8,11]},
    {"id":"chromatic",       "label":"Chromatique",            "label_en":"Chromatic",              "sub":"12 notes",            "sub_en":"12 notes",            "group":1,"diat":False,"fam":"maj","ls":[0,1,1,2,2,3,4,4,5,5,6,6], "iv":list(range(12))},
    # GROUPE 2 — MODES JAZZ
    ...
    {"id":"saba",            "label":"Saba",                   "label_en":"Saba",                   "sub":"Maqam",                "sub_en":"Maqam",               "group":3,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6],"iv":[0,1,3,4,7,8,10]},
    ...
    {"id":"dorian_b5", "label":"Dorien ♭5", "label_en":"Dorian ♭5", "sub":"Mode II maj. harm.", "sub_en":"Mode II harm. maj.", "group":2,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6], "iv":[0,2,3,5,6,9,10]},
    {"id":"phrygian_b4", "label":"Phrygien ♭4", "label_en":"Phrygian ♭4", "sub":"Mode III maj. harm.", "sub_en":"Mode III harm. maj.", "group":2,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6], "iv":[0,1,3,4,7,8,10]},
    {"id":"lydian_b3", "label":"Lydien ♭3", "label_en":"Lydian ♭3", "sub":"Mode IV maj. harm.", "sub_en":"Mode IV harm. maj.", "group":2,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6], "iv":[0,2,3,6,7,9,11]},
    {"id":"mixolydian_b2", "label":"Mixolydien ♭2", "label_en":"Mixolydian ♭2", "sub":"Mode V maj. harm.", "sub_en":"Mode V harm. maj.", "group":2,"diat":False,"fam":"maj","ls":[0,1,2,3,4,5,6], "iv":[0,1,4,5,7,9,10]},
    {"id":"lydian_aug_s2", "label":"Lydien augmenté ♯2", "label_en":"Lydian augmented ♯2", "sub":"Mode VI maj. harm.", "sub_en":"Mode VI harm. maj.", "group":2,"diat":False,"fam":"maj","ls":[0,1,2,3,4,5,6], "iv":[0,3,4,6,8,9,11]},
    {"id":"locrian_bb7", "label":"Locrien ♭♭7", "label_en":"Locrian ♭♭7", "sub":"Mode VII maj. harm.", "sub_en":"Mode VII harm. maj.", "group":2,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6], "iv":[0,1,3,5,6,8,9]},
    {"id":"lydian_s2s6", "label":"Lydien ♯2 ♯6", "label_en":"Lydian ♯2 ♯6", "sub":"Mode II dbl harm.", "sub_en":"Mode II dbl harm.", "group":3,"diat":False,"fam":"maj","ls":[0,1,2,3,4,5,6], "iv":[0,3,4,6,7,10,11]},
    {"id":"ultraphrygian", "label":"Ultraphrygien", "label_en":"Ultraphrygian", "sub":"Mode III dbl harm.", "sub_en":"Mode III dbl harm.", "group":3,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6], "iv":[0,1,3,4,7,8,9]},
    {"id":"ionian_s2s5", "label":"Ionien ♯2 ♯5", "label_en":"Ionian ♯2 ♯5", "sub":"Mode VI dbl harm.", "sub_en":"Mode VI dbl harm.", "group":3,"diat":False,"fam":"maj","ls":[0,1,2,3,4,5,6], "iv":[0,3,4,5,8,9,11]},
    {"id":"locrian_bb3bb7", "label":"Locrien ♭♭3 ♭♭7", "label_en":"Locrian ♭♭3 ♭♭7", "sub":"Mode VII dbl harm.", "sub_en":"Mode VII dbl harm.", "group":3,"diat":False,"fam":"min","ls":[0,1,1,3,4,5,6], "iv":[0,1,2,5,6,8,9]},
    {"id":"purvi", "label":"Purvi", "label_en":"Purvi", "sub":"Thaat", "sub_en":"Thaat", "group":3,"diat":False,"fam":"maj","ls":[0,1,2,3,4,5,6], "iv":[0,1,4,6,7,8,11]},
    {"id":"marwa", "label":"Marwa", "label_en":"Marwa", "sub":"Thaat", "sub_en":"Thaat", "group":3,"diat":False,"fam":"maj","ls":[0,1,2,3,4,5,6], "iv":[0,1,4,6,7,9,11]},
    {"id":"leading_wt", "label":"Par tons ascendante", "label_en":"Leading whole tone", "sub":"6 notes + 7ème", "sub_en":"6 notes + 7th", "group":1,"diat":False,"fam":"maj","ls":[0,1,2,3,4,5,6], "iv":[0,2,4,6,8,10,11]},
    {"id":"tritone_sc", "label":"Triton", "label_en":"Tritone", "sub":"6 notes, symétrique", "sub_en":"6 notes, symmetric", "group":1,"diat":False,"fam":"maj","ls":[0,1,2,4,4,6], "iv":[0,1,4,6,7,10]},
    {"id":"two_semitone_tritone", "label":"Deux demi-tons triton", "label_en":"Two-semitone tritone", "sub":"6 notes, symétrique", "sub_en":"6 notes, symmetric", "group":1,"diat":False,"fam":"maj","ls":[0,1,1,4,4,5], "iv":[0,1,2,6,7,8]},
    {"id":"prometheus_nea", "label":"Prometheus napolitain", "label_en":"Neapolitan Prometheus", "sub":"6 notes", "sub_en":"6 notes", "group":1,"diat":False,"fam":"maj","ls":[0,1,2,4,5,6], "iv":[0,1,4,6,9,10]},
    {"id":"enigmatic_min", "label":"Énigmatique mineure", "label_en":"Enigmatic minor", "sub":"7 notes", "sub_en":"7 notes", "group":3,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6], "iv":[0,1,3,6,7,10,11]},
    {"id":"bebop_melodic", "label":"Bebop mineure mélodique", "label_en":"Bebop melodic minor", "sub":"8 notes", "sub_en":"8 notes", "group":2,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,5,6], "iv":[0,2,3,5,7,8,9,11]},
    {"id":"bebop_harm_min", "label":"Bebop mineure harmonique", "label_en":"Bebop harmonic minor", "sub":"8 notes", "sub_en":"8 notes", "group":2,"diat":False,"fam":"min","ls":[0,1,2,3,4,5,6,6], "iv":[0,2,3,5,7,8,10,11]},
    {"id":"man_gong", "label":"Man Gong", "label_en":"Man Gong", "sub":"Pentatonique", "sub_en":"Pentatonic", "group":1,"diat":False,"fam":"min","ls":[0,2,3,5,6], "iv":[0,3,5,8,10]},
    {"id":"pelog", "label":"Pelog balinais", "label_en":"Balinese Pelog", "sub":"Pentatonique", "sub_en":"Pentatonic", "group":3,"diat":False,"fam":"min","ls":[0,1,2,4,5], "iv":[0,1,3,7,8]},
    {"id":"algerian", "label":"Algérienne", "label_en":"Algerian", "sub":"8 notes", "sub_en":"8 notes", "group":3,"diat":False,"fam":"min","ls":[0,1,2,3,4,4,5,6], "iv":[0,2,3,5,6,7,8,11]},
]
...
# ---------------------------------------------------------------------------
SCALE_DESCS = {
    "dorian_b5": "Mode II de la majeure harmonique : un dorien dont la quinte est diminuée. Sa sixte majeure sur quinte bémol crée une couleur instable mais lumineuse, utile sur les accords m7♭5 quand le locrien ♮2 sonne trop convenu.",
    "phrygian_b4": "Mode III de la majeure harmonique. Sa quarte diminuée, enharmonique de la tierce majeure, lui donne une ambiguïté majeur-mineur permanente. Même ensemble de notes que le maqam Saba, dont il partage la mélancolie.",
    "lydian_b3": "Mode IV de la majeure harmonique, aussi appelé mineure mélodique ♯4. Il réunit la tierce mineure et la quarte augmentée du lydien, ce qui en fait une gamme de choix sur les accords mineurs à sonorité flottante.",
    "mixolydian_b2": "Mode V de la majeure harmonique : un mixolydien à seconde mineure. Il conserve la sixte majeure, ce qui le distingue du phrygien dominant et lui donne une tension plus douce sur les accords de dominante.",
    "lydian_aug_s2": "Mode VI de la majeure harmonique. Seconde augmentée, quarte augmentée et quinte augmentée s'y cumulent : c'est l'un des modes les plus tendus du système, réservé aux accords maj7♯5 dans les contextes les plus chromatiques.",
    "locrian_bb7": "Mode VII de la majeure harmonique : le locrien dont la septième est doublement bémol. Il contient un arpège diminué 7 complet et sert à improviser sur les accords dim7 en gardant une couleur phrygienne.",
    "lydian_s2s6": "Mode II de la double harmonique. Ses deux secondes augmentées encadrent une quinte juste, ce qui produit une couleur orientale très marquée tout en restant jouable sur un accord majeur 7.",
    "ultraphrygian": "Mode III de la double harmonique. Quarte diminuée et septième doublement bémol s'ajoutent à la seconde mineure du phrygien : une gamme dense, presque entièrement chromatique dans sa première moitié.",
    "ionian_s2s5": "Mode VI de la double harmonique. La gamme majeure y reçoit une seconde et une quinte augmentées : la tonique reste claire mais l'accord de dominante devient augmenté, d'où son usage dans le néoclassique.",
    "locrian_bb3bb7": "Mode VII de la double harmonique, le plus rare du groupe. Ses trois premiers degrés sont chromatiques et sa septième doublement bémol la rapproche d'un arpège diminué orné.",
    "purvi": "Le thaat Purvi associe une seconde et une sixte mineures à une quarte augmentée et une septième majeure. Réservé aux ragas de fin d'après-midi, il produit une gravité solennelle que peu de gammes occidentales atteignent.",
    "marwa": "Le thaat Marwa est un lydien à seconde mineure. L'absence d'appui sur la quinte dans les ragas qui en dérivent crée une sensation de suspension permanente, associée au crépuscule.",
    "leading_wt": "La gamme par tons ascendante est une gamme par tons à laquelle on ajoute la septième majeure. Cette seule note lui rend une sensible, donc une direction, là où la gamme par tons flotte sans résolution.",
    "tritone_sc": "La gamme triton se répète tous les six demi-tons : deux cellules identiques à un triton d'écart. Elle contient deux accords de dominante distants d'un triton, ce qui en fait l'outil naturel de la substitution tritonique.",
    "two_semitone_tritone": "Gamme symétrique formée de deux amas chromatiques de trois notes séparés par un triton. Sans tierce ni septième, elle ne définit aucun accord et sert surtout de matière sonore en écriture contemporaine.",
    "prometheus_nea": "Variante du Prometheus de Scriabine dont la seconde est abaissée. Comme lui, elle est bâtie sur l'accord mystique et refuse la quinte juste, ce qui suspend toute gravitation tonale.",
    "enigmatic_min": "Version mineure de la gamme énigmatique de Verdi. Seconde mineure, quarte augmentée et septième majeure y coexistent avec une tierce mineure : une gamme délibérément instable, conçue comme une énigme harmonique.",
    "bebop_melodic": "La mineure mélodique augmentée d'une sixte mineure de passage. Cette huitième note aligne les notes de l'accord sur les temps forts et permet de descendre la gamme sans casser le swing.",
    "bebop_harm_min": "La mineure harmonique augmentée d'une septième mineure de passage. Les deux septièmes cote à cote permettent d'enchaîner les phrases sur un accord mineur sans perdre la sensible.",
    "man_gong": "Cinquième rotation de la pentatonique majeure, la plus sombre des cinq. Très utilisée dans la musique chinoise, elle fonctionne aussi comme pentatonique mineure à sixte bémol sur les accords mineurs.",
    "pelog": "Approximation tempérée du pelog du gamelan balinais. Ses deux demi-tons resserrés autour de la tonique et de la quinte produisent une couleur suspendue très reconnaissable.",
    "algerian": "Gamme à huit notes bâtie sur la mineure harmonique avec une quarte augmentée de passage. Ses deux quintes voisines lui donnent une tension mobile caractéristique du Maghreb.",
    ...
    "half_dim":     "Le mode VI de la mineure mélodique : le locrien avec la 2nde majeure. C'est la gamme de référence sur les accords demi-diminués (iiø7) en jazz, préférée au locrien dont le b2 heurte la fondamentale. Sa b5 crée une tension immédiate qui demande résolution.",
...
# ---------------------------------------------------------------------------
SCALE_DESCS_EN = {
    "dorian_b5": "Mode II of the harmonic major: a Dorian with a diminished fifth. Its major sixth over a flat fifth creates an unstable yet bright color, useful over m7♭5 chords when Locrian ♮2 sounds too predictable.",
    "phrygian_b4": "Mode III of the harmonic major. Its diminished fourth, enharmonic with the major third, gives it a permanent major-minor ambiguity. Same pitch set as the Saba maqam, whose melancholy it shares.",
    "lydian_b3": "Mode IV of the harmonic major, also called melodic minor ♯4. It combines a minor third with the Lydian augmented fourth, making it a strong choice over minor chords with a floating sound.",
    "mixolydian_b2": "Mode V of the harmonic major: a Mixolydian with a minor second. It keeps the major sixth, which sets it apart from the Phrygian dominant and gives it a gentler tension over dominant chords.",
    "lydian_aug_s2": "Mode VI of the harmonic major. Augmented second, augmented fourth and augmented fifth pile up: one of the most tense modes in the system, reserved for maj7♯5 chords in the most chromatic contexts.",
    "locrian_bb7": "Mode VII of the harmonic major: Locrian with a doubly flattened seventh. It contains a complete diminished 7 arpeggio and is used over dim7 chords while keeping a Phrygian color.",
    "lydian_s2s6": "Mode II of the double harmonic. Its two augmented seconds surround a perfect fifth, producing a strongly Oriental color that still works over a major 7 chord.",
    "ultraphrygian": "Mode III of the double harmonic. A diminished fourth and a doubly flattened seventh are added to the Phrygian minor second: a dense scale, almost entirely chromatic in its lower half.",
    "ionian_s2s5": "Mode VI of the double harmonic. The major scale gets an augmented second and an augmented fifth: the tonic stays clear but the dominant chord becomes augmented, hence its use in neoclassical writing.",
    "locrian_bb3bb7": "Mode VII of the double harmonic, the rarest of the group. Its first three degrees are chromatic and its doubly flattened seventh makes it close to an ornamented diminished arpeggio.",
    "purvi": "The Purvi thaat pairs a minor second and minor sixth with an augmented fourth and a major seventh. Reserved for late-afternoon ragas, it produces a solemn gravity few Western scales reach.",
    "marwa": "The Marwa thaat is a Lydian with a minor second. The ragas derived from it avoid resting on the fifth, creating a permanent sense of suspension associated with dusk.",
    "leading_wt": "The leading whole tone scale is a whole tone scale with an added major seventh. That single note restores a leading tone, and therefore a direction, where the whole tone scale floats without resolution.",
    "tritone_sc": "The tritone scale repeats every six semitones: two identical cells a tritone apart. It contains two dominant chords a tritone apart, making it the natural tool for tritone substitution.",
    "two_semitone_tritone": "Symmetric scale made of two three-note chromatic clusters a tritone apart. With neither third nor seventh, it defines no chord and mainly serves as sound material in contemporary writing.",
    "prometheus_nea": "A variant of Scriabin's Prometheus with a lowered second. Like it, it is built on the mystic chord and refuses the perfect fifth, suspending any tonal gravitation.",
    "enigmatic_min": "Minor version of Verdi's enigmatic scale. Minor second, augmented fourth and major seventh coexist with a minor third: a deliberately unstable scale, conceived as a harmonic riddle.",
    "bebop_melodic": "The melodic minor with an added minor sixth passing note. This eighth note aligns chord tones with strong beats and allows descending the scale without breaking the swing.",
    "bebop_harm_min": "The harmonic minor with an added minor seventh passing note. The two sevenths side by side allow chaining phrases over a minor chord without losing the leading tone.",
    "man_gong": "Fifth rotation of the major pentatonic, the darkest of the five. Widely used in Chinese music, it also works as a flat-sixth minor pentatonic over minor chords.",
    "pelog": "Tempered approximation of the Balinese gamelan pelog. Its two semitones tightened around the tonic and the fifth produce a very recognizable suspended color.",
    "algerian": "Eight-note scale built on the harmonic minor with an added augmented fourth passing note. Its two neighbouring fifths give it the mobile tension characteristic of the Maghreb.",
    ...
    "half_dim":     "Mode VI of the melodic minor: Locrian with a major 2nd. It is the reference scale over half-diminished chords (iiø7) in jazz, preferred to Locrian whose b2 clashes with the root. Its b5 creates immediate tension demanding resolution.",
